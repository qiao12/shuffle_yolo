...
class YOLOCubeHead(BaseDenseHead, BBoxTestMixin):
    ...
    def __init__(self,
        ...
        super(YOLOCubeHead, self).__init__(init_cfg)
        # Check params
    ...
    def loss(self,
        ...
        # print("featmaps_sizes0：{}".format(featmap_sizes[0]))
        # print("featmaps_sizes1：{}".format(featmap_sizes[1]))
        multi_level_anchors = self.anchor_generator.grid_anchors(
            featmap_sizes, device)
        print("输出的level数：{}".format(multi_level_anchors.__len__()),"单层anchor数：{}".format(multi_level_anchors[0].size()))
        anchor_list = [multi_level_anchors for _ in range(num_imgs)]


        # anchor_list.size = batchsize * num_level *(3*H*W)*4
    ...
    def get_targets(self, anchor_list, responsible_flag_list, gt_bboxes_list,
        ...
        # print(gt_bboxes_list[0])
        # anchor number of multi levels
        # 2* 1083*4
        #  anchor_list[0] shape为[[,969,4],[3876,4]]
    ...
    def _get_targets_single(self, anchors, responsible_flags, gt_bboxes,
        ...
        # print("concat_anchor size:{}".format(concat_anchors.size()))
            # torch.Size([5415, 4]) =1083 +4332 = 3 * 19 * 19 +3 * 38 * 38
